...
public class ErrorMessages {
    public static final String INVALID_LENGTH_ERROR_MESSAGE =
            "[ERROR] 로또 번호는 " + VALID_LOTTERY_NUMBER_LENGTH + "개의 숫자로 이루어져야 합니다.";
    public static final String DUPLICATE_LOTTO_NUMBER_ERROR_MESSAGE = "[ERROR] 로또 번호는 중복되지 않아야 합니다.";
    public static final String INVALID_RANGE_ERROR_MESSAGE =
            "[ERROR] 로또 번호는 " + VALID_MIN_RANGE + "부터 " + VALID_MAX_RANGE + "사이의 숫자여야 합니다";
    public static final String INVALID_TYPE_ERROR_MESSAGE = "[ERROR] 로또 번호는 정수여야 합니다.";
    public static final String INVALID_PAID_MONEY_MESSAGE = "[ERROR] 지불된 금액은 " + LOTTO_PRICE + "원 단위여야 합니다.";
