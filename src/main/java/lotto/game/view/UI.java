...
public class UI {
    ...
    public void printTotalResult(Map<LottoGrade, Integer> totalWinnings) {
        ...
        System.out.printf("5개 일치 (1,500,000원) - %d개%n", totalWinnings.getOrDefault(LottoGrade.THIRD, 0));
