...
public class InputView {
    ...
    public static final String PRINT_ASK_AMOUT = "구입금액을 입력해 주세요.";
    public static final String PRINT_ASK_WINNING_LOTTO = "당첨 번호를 입력해 주세요.";
    public static final String PRINT_ASK_BONUS_LOTTO = "보너스 번호를 입력해 주세요.";
