...
public final class MessageConstants {
    ...
    public static final String PURCHASED_MESSAGE = "개를 구매했습니다.";
    public static final String WIN_STAT_MESSAGE = "당첨 통계\n---";
    public static final String ROR_START_MESSAGE = "총 수익률은 ";
