...
public enum ErrorType {
    ...
    PLAYER_NUMBER_RANGE_ERROR("로또 번호는 1부터 45 사이의 숫자여야 합니다."),
    PLAYER_NUMBERS_DUPLICATION_ERROR("당첨 번호에 중복된 번호가 존재합니다."),
    BONUS_NUMBER_DUPLICATION_ERROR("당첨 번호에 중복된 번호가 존재합니다."),
    ;
