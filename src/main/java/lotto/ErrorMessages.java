...
public class ErrorMessages extends Constants {
    private static final String prefix = "[ERROR] ";
    private static final String isNotNumber = "은(는) 숫자여야 합니다.";
    private static final String isUnableMoney = String.format("은 %d의 배수여야 합니다.", PRICE);
    private static final String isOutOfBounds = String.format("는 %d부터 %d 사이의 숫자여야 합니다.", MIN, MAX);
    private static final String isNotMatch = String.format("는 %d개여야 합니다.", MAX_COUNT);
