...
public class Constant {
    public static final String FIRST_PLACE = "6";
    public static final String SECOND_PLACE = "bonus";
    public static final String THIRD_PLACE = "5";
    public static final String FOURTH_PLACE = "4";
    public static final String FIFTH_PLACE = "3";
    public static final String ASK_PRICE = "구입금액을 입력해 주세요.";
    public static final String SHOW_BUY_COUNT = "개를 구매했습니다.";
    ...
    public static final String FIVE_BONUS_MATCH = "5개 일치, 보너스 볼 일치 (30,000,000원) - ";
