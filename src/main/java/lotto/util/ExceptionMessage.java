...
public final class ExceptionMessage {
    ...
    public static final String NUMBER_COUNT_NOT_EQUAL = "[ERROR] 입력된 당첨번호는 6개의 숫자가 아닙니다.";
    public static final String NUMBER_EACH_NOT_NUMBER = "[ERROR] 입력된 당첨번호는 각각이 숫자여야 합니다.";
