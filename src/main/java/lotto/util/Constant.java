...
public class Constant {
    ...
    public static final String GAMESTART = "구입 금액을 입력해주세요.";
    public static final String COUNTBUYLOTTO = "개를 구입하셨습니다.";
    public static final String REQUESTWINNINGNUMBER = "당첨 번호를 입력해 주세요.";
    public static final String REQUESTBONUSNUMBKER = "보너스 번호를 입력해 주세요.";
    public static final String RESULTOFANNOUNCEMENTBEGIN = "당첨 통계\n---";

    public static String RESULT1 = "개 일치";
