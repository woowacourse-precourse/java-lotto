...
public class PurchaseAmount {
    public static void exceptionPurchaseAmount(String purchaseAmount) {
        exceptionNoNumber(purchaseAmount);
        exceptinoLessThanPrice(purchaseAmount);
        exceptionDividePrice(purchaseAmount);
    }
