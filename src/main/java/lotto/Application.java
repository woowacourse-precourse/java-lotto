...
public class Application {
	public static void main(String[] args) {
		...
		printWinningRate(earning, count);
	...
	public static int printWinningResult(List<Integer> winningNumber, int bonusNumber, List<Lotto> lottoNumbers) {
		...
		return (5000 * result[3] + 50000 * result[4] + 1500000 * result[5] + 30000000 * result[7]
				+ 2000000000 * result[6]);
	}
	...
	public static void printWinningRate(int earning, int count) {
