...
public class BuyConsole {
    ...
    public static final String FORTH = "4개 일치 (50,000원) - ";
    public static final String FIFTH = "3개 일치 (5,000원) - ";
    public static final String PROFIT = "총 수익률은 %.1f입니다.";
    ...
    public void printStatistics(Map<WinningTable, Integer> map, double profitRate) {
        ...
        System.out.println(FIFTH + map.get(WinningTable.FIFTH));
        System.out.println(FORTH + map.get(WinningTable.FORTH));
        System.out.println(THIRD + map.get(WinningTable.THIRD));
        System.out.println(SECOND + map.get(WinningTable.SECOND));
        System.out.println(FIRST + map.get(WinningTable.FIRST));
