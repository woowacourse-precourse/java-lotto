...
public class PrintMessenger {
    ...
    public static void winningResult(int [] countResult)// list를 받을지 int를 받을지 고민;;
    {
        ...
        System.out.println("5개 일치 (1,500,000원) -"+ countResult[5] +"0개");
        System.out.println("5개 일치, 보너스 볼 일치 (30,000,000원) -"+ countResult[6] +"0개");
        System.out.println("6개 일치 (2,000,000,000원) -"+ countResult[7] +"0개");
    }
