...
public final class ErrorMessage {
    ...
    public static final String INVALID_LOTTO_NUMBER_RANGE_ERROR = "로또 번호는 1부터 45사이의 값이어야 합니다.";
    ...
    public static final String INVALID_WINNING_NUMBER_SIZE_ERROR = "당첨 로또 번호는 6개의 숫자여야 합니다.";
