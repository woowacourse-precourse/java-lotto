...
public class Message {
    ...
    public static final String THREE_MATCHES = "3개 일치 (5,000원) - 개";
    public static final String FOUR_MATCHES = "4개 일치 (50,000원) - 개";
    public static final String FIVE_MATCHES = "5개 일치 (1,500,000원) - 개";
    public static final String FIVE_BONUS_MATCHES = "5개 일치, 보너스 볼 일치 (30,000,000원) - 개";
    public static final String ALL_MATCHES = "6개 일치 (2,000,000,000원) - 개";
