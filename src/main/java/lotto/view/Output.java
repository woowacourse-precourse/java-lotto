...
public class Output {
    private final String QUANTITY_OF_LOTTO = "개를 구매했습니다.";
    private final String WINNING_STATISTICS = "당첨 통계";
    private final String PERFORATION = "---";
    private final String THREE_CORRECT = "3개 일치 (5,000원) - ";
    private final String FOUR_CORRECT = "4개 일치 (50,000원) - ";
    private final String FIVE_CORRECT = "5개 일치 (1,500,000원) - ";
    private final String FIVE_AND_BONUS_CORRECT = "5개 일치, 보너스 볼 일치 (30,000,000원) - ";
    private final String SIX_CORRECT = "6개 일치 (2,000,000,000원) - ";
    private final String TOTAL_PROFIT = "총 수익률은 .%1f%입니다.";

    private Output() {
    }

    private void printQuantityOfLotto(int quantity) {
        System.out.println(quantity + QUANTITY_OF_LOTTO);
    }

    private void printLottoTickets(Set<List<Integer>> lottoTickets) {
        for (List<Integer> lottoTicket : lottoTickets) {
            System.out.println(formLottoTicket(lottoTicket));
        }
    }

    private String formLottoTicket(List<Integer> lottoTicket) {
    ...
    private void printTotalRank(Map<Integer, Integer> totalRank) {
    ...
    private double calculateRateOfReturn(long sumOfPrize, int purchaseAmount) {
