...
public class OutputConstants {
    public static final String INPUT_PURCHASE_MONEY_SENTENCE = "구입금액을 입력해 주세요.";
    public static final String OUTPUT_NUMBER_OF_PURCHASE_LOTTO = "%d개를 구매했습니다.";
    public static final String INPUT_WINNING_NUMBERS_SENTENCE = "당첨 번호를 입력해 주세요.";
