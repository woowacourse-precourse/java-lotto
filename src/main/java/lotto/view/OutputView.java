...
public class OutputView {
    ...
    public void purchaseLottoResultPrint(List<Lotto> lotto){
    ...
    public void StatsResultPrint(Map<StatsType,Integer> lottoStats, Double earning){
        StringBuffer response = new StringBuffer();
    ...
    private void StatsFormat(StringBuffer response, Integer count,  Integer bonus,Integer matchCount,String moneyFormat){
        if(bonus > 0){
