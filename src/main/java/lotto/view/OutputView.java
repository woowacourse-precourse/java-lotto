...
public class OutputView {
    ...
    private static final String WINNING_NUMBERS_ENTERING_GUIDE_MESSAGE = "당첨 번호를 입력해 주세요.";
    private static final String BONUS_NUMBER_ENTERING_GUIDE_MESSAGE = "보너스 번호를 입력해 주세요.";
