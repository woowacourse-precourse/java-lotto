...
public enum LottoError {
    HEAD("[ERROR] "),
    NOT_6_LENGTH(String.format("로또 번호는 총 %d개여야 합니다.", LottoCondition.LOTTO_RANGE_LENGTH.getNum())),
    DUPLICATE_FOUND("로또 번호는 서로 다른 숫자여야 합니다."),
    NOT_IN_RANGE(String.format("로또 번호는 %d부터 %d 사이의 숫자여야 합니다.", LottoCondition.LOTTO_RANGE_MIN.getNum(), LottoCondition.LOTTO_RANGE_MAX.getNum())),
