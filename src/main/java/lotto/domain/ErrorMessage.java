...
public abstract class ErrorMessage {
    ...
    public static final String LOTTO_PURCHASE_MONEY_ERROR_MESSAGE = "[ERROR] 티켓은 1000원 입니다. 1000원 단위로 입력해야 합니다.";
    ...
    public static final String BONUS_NUMBER_DUPLICATE_ERROR_MESSAGE = "[ERROR] 보너스 번호는 당첨 번호와 중복되지 않아야 합니다.";
}
