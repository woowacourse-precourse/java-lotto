...
public enum ErrorMessage {
    ...
    LOTTO_NUMBER_DUPLICATE("[ERROR] 로또 번호에 중복된 숫자가 있으면 안된다."),

    WINNING_NUMBER_ONLY_NUMBER_AND_COMMA("[ERROR] 로또 당첨 번호는 숫자와 쉼표만으로 구성해야 한다."),

    BONUS_NUMBER_ONLY_NUMBER("[ERROR] 로또 보너스 번호는 숫자로 구성해야 한다."),
    BONUS_NUMBER_DUPLICATE_WINNING_NUMBER("[ERROR] 로또 보너스 번호는 로또 당첨 번호와 중복되면 안된다."),
