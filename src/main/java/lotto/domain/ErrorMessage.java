...
public abstract class ErrorMessage {
    ...
    public static final String LOTTO_PURCHASE_MONEY_ERROR_MESSAGE = "티켓은 1000원 입니다. 1000원 단위로 입력해야 합니다.";
    ...
    public static final String LOTTO_NUMBER_SIZE_ERROR_MESSAGE = "로또 번호의 개수는 " + Lotto.NUMBER_SIZE +"개여야 합니다.";
