...
public class ComparingMachine {
    ...
    public void countWinResult() {
        for (int i = 0; i < containNumberList.size(); i++) {
            if (containNumberList.get(i) == 3) {
                third++;
            }
            if (containNumberList.get(i) == 4) {
                fourth++;
            }
            if (containNumberList.get(i) == 5 && containBonusNumber.get(i) == 0) {
                fifth++;
            }
            if (containNumberList.get(i) == 5 && containBonusNumber.get(i) == 1) {
                fifth_bonus++;
            }
            if (containNumberList.get(i) == 6) {
                sixth++;
            }
        }
