...
public class Constants {
    ...
    public static final String PURCHASE_QUANTITY_NOTICE = "개를 구매했습니다.";
    public static final String TOTAL_EARNING_IS = "총 수익률은 ";
    public static final String PERCENT_NOTICE = "%입니다.";
