...
public class WonNumber {
    ...
    public void bonusNumber(){
        int addLastNumber  = Integer.parseInt(inPutSystem.inputNumber());
        wonNumber.add(addLastNumber);
    }
    public void validate(List<Integer> wonNumber){
        ...
        for (int wonNumbers : wonNumber) {
            if (Character.isDigit(wonNumbers) || wonNumbers == 0) {
                throw new IllegalArgumentException();
            }
        }
    }
