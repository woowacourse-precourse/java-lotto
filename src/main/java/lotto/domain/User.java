...
public class User {
    ...
    public void SetAnswerNumber(List<Integer> answerNumber){ this.answerNumber = answerNumber; }
    ...
    public List<Integer> GetLottoAnswer() { return answerNumber; }
    public List<Lotto> GetMyLotto() { return myLotto; }
