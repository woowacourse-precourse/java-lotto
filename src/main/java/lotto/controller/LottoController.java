...
public class LottoController {
    ...
    /**
     * generate list set of random lotto numbers
     * @param purchaseAmount number of set
     * @return random lotto numbers
     */
    ...
    /**
     * get prize numbers, bonus number from user and calculate statistics<br/>
     * after get statistics, print the statistics
     *
     * @param userLottoList list that generated by LottoRandom.generateRandomLottoNumberList
