...
public class WinResultManager {
    ...
    public static CorrectNumber returnCorrectNumber(List<Integer> lottoNumbers,
            List<Integer> winNumbers) {
        List<CorrectNumber> correctNumberList = new ArrayList<>(
                Arrays.asList(CorrectNumber.values()));
        ...
        for (CorrectNumber correctNumber : correctNumberList) {
            if (matchedNumber >= LEAST_WIN_NUMBER
                    && correctNumber.getCorrectNumber() == matchedNumber) {
