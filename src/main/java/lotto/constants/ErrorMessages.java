...
public class ErrorMessages {
    ...
    private static final String isUnableMoney
            = String.format("은 %d의 배수여야 합니다.", Constants.PRICE);
    private static final String isOutOfBounds
            = String.format("는 %d부터 %d 사이의 숫자여야 합니다.", Constants.MIN, Constants.MAX);
    private static final String isNotMatch
            = String.format("는 %d개여야 합니다.", Constants.MAX_COUNT);
