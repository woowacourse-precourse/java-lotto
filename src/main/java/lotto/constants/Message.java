...
public class Message {
	...
	public static final String ERROR_EMPTY_PURCHASE_AMOUNT_INPUT = ERROR_PREFIX + "빈 문자열을 입력하면 안됩니다.";
	public static final String ERROR_NOT_NUMERIC_PURCHASE_AMOUNT_INPUT = ERROR_PREFIX + "숫자만 입력해야 합니다.";
	public static final String ERROR_FIRST_ZERO_PURCHASE_AMOUNT_INPUT = ERROR_PREFIX + "맨 첫 숫자는 0이면 안됩니다.";
