...
public enum InputViewMessageUtils {
    ...
    WINNING_NUMBERS(CommonMessageConst.LINE_FEED + "당첨 번호를 입력해 주세요.", LottoGameStatus.GUIDE_WINNING_NUMBERS),
    BONUS_NUMBER(CommonMessageConst.LINE_FEED + "보너스 번호를 입력해 주세요.", LottoGameStatus.GUIDE_BONUS_NUMBER);
