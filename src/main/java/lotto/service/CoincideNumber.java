...
public enum CoincideNumber {
    THREE_COINCIDE("3개 일치 (5,000원) - ",5,0,5000),
    FOUR_COINCIDE("4개 일치 (50,000원) - ",4,0,50000),
    FIVE_COINCIDE("5개 일치 (1,500,000원) - ",3,0,1500000),
    FIVE_BONUS_COINCIDE("5개 일치, 보너스 볼 일치 (30,000,000원) - ",2,0,30000000),
