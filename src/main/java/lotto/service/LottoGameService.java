...
public class LottoGameService {
    ...
    public int getLottoIssueCount(int lottoPurchaseAmount) {
        ...
        return lottoPurchaseAmount / A_LOTTO_PRICE;
    }

    public void validateLottoIssueCount(int lottoPurchaseAmount) {
    ...
    private boolean isRestOfLottoPurchaseAmountDivideBy1000NotZero(int lottoPurchaseAmount) {
        return lottoPurchaseAmount % A_LOTTO_PRICE != 0;
    }
}
