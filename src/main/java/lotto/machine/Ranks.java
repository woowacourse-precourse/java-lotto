...
public enum Ranks {
    ...
    FOUR_NUMBERS(4, 50_000, "4개 일치 (50,000원)"),
    FIVE_NUMBERS(5, 1_500_000, "5개 일치 (1,500,000원)"),
    BONUS_NUMBERS(5, 30_000_000, "5개 일치, 보너스 볼 일치 (30,000,000원)"),
    SIX_NUMBERS(6, 2_000_000_000, "6개 일치 (2,000,000,000원)");
