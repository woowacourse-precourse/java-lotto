...
public class Message {
    ...
    public static final String ZERO_PRICE_ERROR = " 입력한 금액이 0원 입니다.";
    public static final String NO_THOUSAND_PRICE_ERROR = " 1,000 배수의 금액만 입력이 가능합니다.";
    public static final String HAS_BONUS_NUMBER_ERROR = " 로또 번호에 이미 있는 번호가 입력되었습니다.";
    public static final String NO_NUMBER_RANGE_ERROR = " 1~45 사이의 값만 입력이 가능합니다.";
    public static final String NUMBERS_SIZE_SIX_FIT_ERROR = " 6개의 값만 입력이 가능합니다.";
