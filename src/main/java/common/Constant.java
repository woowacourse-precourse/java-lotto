...
public final class Constant {
    ...
    public static final String WINNING_LOTTO_THREE_MESSAGE = "3개 일치 (5,000원) - ";
    public static final String WINNING_LOTTO_FOUR_MESSAGE = "4개 일치 (50,000원) - ";
    public static final String WINNING_LOTTO_FIVE_MESSAGE = "5개 일치 (1,500,000원) - ";
    public static final String WINNING_LOTTO_FIVE_BONUS_MESSAGE = "5개 일치, 보너스 볼 일치 (30,000,000원) - ";
    public static final String WINNING_LOTTO_SIX_MESSAGE = "6개 일치 (2,000,000,000원) - ";

    public static void PLAYER_YIELD_MESSAGE(double yield){
