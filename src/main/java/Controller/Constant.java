...
public class Constant {
    ...
    static final String ERROR_MESSAGE_DELIMITER_NUMBER_IS_INCORRECT = ERROR_MESSAGE + " 구분자(" + SEPARATOR + ")의 개수가 입력 조건에 맞지 않습니다.";
    static final String ERROR_MESSAGE_BETWEEN_NUMBER_NOT_DELIMITER = ERROR_MESSAGE + " 당첨 번호 입력에서 구분자(" + SEPARATOR + ")의 위치가 입력 조건에 맞지 않습니다. 콤마(,)는 숫자 사이에 존재해야 합니다.";
    static final String ERROR_MESSAGE_BETWEEN_DELIMITER_NOT_NUMBER = ERROR_MESSAGE + " 당첨 번호 입력에서 구분자(" + SEPARATOR + ")사이에 데이터가 숫자로 이루어진 데이터가 아닙니다.";
