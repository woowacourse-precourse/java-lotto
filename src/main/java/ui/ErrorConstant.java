...
public final class ErrorConstant {
    ...
    public static final String MONEY_NOT_DIVIDE_1000 = ERROR_HEAD + MONEY + "은 1000단위여야 합니다.";
    ...
    public static final String LOTTO_HAVE_BONUS = ERROR_HEAD + "보너스는 당첨 로또에 존재할 수 없습니다.";
