...
public class DecimalFormatTest {
    ...
    void 세자리마다_컴마를_잘_찍는지_테스트한다(float target, String expected) {
    ...
    void 소숫점은_컴마를_안_찍는지_테스트한다(float target, String expected) {
        DecimalFormat formatter = new DecimalFormat("###,###.########");
        assertThat(formatter.format(target)).isEqualTo(expected);
    }
    ...
    void 소숫점이_없어도_소수점을_0으로_나타내는지_테스트한다(float target, String expected) {
