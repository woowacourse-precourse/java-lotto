...
class BonusNumTest {
    ...
    void createBonusNumByNotNumber() {
        assertThatThrownBy(() -> new BonusNum("a", pickNumbers))
    ...
    void createBonusNumByDuplicate() {
        assertThatThrownBy(() -> new BonusNum("3", pickNumbers))
                .isInstanceOf(IllegalArgumentException.class);
    }
    ...
    @Test
    void createBonusNum() {
        assertThatCode(() -> { new BonusNum("12", pickNumbers); }).doesNotThrowAnyException();
    }
}
