...
//            result = new Result(profits, spending);
//        }
//
//        @DisplayName("지출 8,000원, 총 당첨금 5,000원, 수익률 62.5%")
//        @Test
//        void percentageTest1() {
//            double actualReturnOnInvestment = result.getReturnOnInvestment();
...
//            Map<Integer, Integer> actualStatistics = result.getStatistics();
