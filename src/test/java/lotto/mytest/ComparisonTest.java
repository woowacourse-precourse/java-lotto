...
public class ComparisonTest {
	...
	@Test
	void compareLotto() {
		Lotto myLotto = (Lotto)List.of(1, 2, 3, 4, 5, 6);
	...
	@Test
	void compareLotto2() {
		Lotto myLotto = (Lotto)List.of(1, 2, 3, 4, 5, 45);
		assertAll(
	...
	@Test
	void compareLotto4() {
		Lotto myLotto = (Lotto)List.of(1, 2, 3, 4, 44, 45);
	...
	@Test
	void compareLotto5() {
		Lotto myLotto = (Lotto)List.of(1, 2, 3, 43, 44, 45);
	...
	@Test
	void compareLotto6() {
		Lotto myLotto = (Lotto)List.of(1, 2, 43, 44, 45, 46);
