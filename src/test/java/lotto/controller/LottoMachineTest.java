...
class LottoMachineTest {
    ...
    class publish {
        ...
        @Test
        void lottoPublish1() {
            Lotto lotto = LottoBox.publishLotto();
        ...
        @Test
        void lottoPublish2() {
            List<Integer> numbers = LottoBox.publishLotto().getNumbers();
    ...
    class ranks {
        ...
        @Test
        void isBonusMatch1() {
            boolean bonusMatch = LottoBox.isBonusMatch(18, lotto);
        ...
        void countMatchNumber() {
            ...
            int count = LottoBox.countMatchNumber(playersLottoNumber, lotto);
        ...
        void getRank() {
            ...
            int bonus = 1;
            Rank rank = LottoBox.getRank(playersLottoNumber, bonus, lotto);
