...
class ValidatorTest {
    ...
    @DisplayName("당첨번호 입력에 콤마 구분자가 없으면 예외가 발생한다.")
    @Test
    ...
    @DisplayName("당첨번호 입력에 중복된 값이 있으면 예외가 발생한다.")
    @Test
    ...
    @DisplayName("당첨번호 입력에 LOTTO_COUNT 만큼의 개수가 없으면 예외가 발생한다.")
    @Test
    ...
    @DisplayName("당첨번호 입력에 1 ~ 45 사이 숫자가 아닌 값이 있으면 예외가 발생한다.")
    @Test
