...
class WinnerTest {
    ...
    private static final String ERROR_OF_INVALID_INPUT = "[ERROR] [ERROR] 숫자가 아닌 값이 포함되어 있습니다. 공백이나 문자가 들어갔는지 확인해주세요.";
    private static final String ERROR_OF_RANGE = "[ERROR] 로또 번호는 1부터 45 사이의 숫자여야 합니다.";
    private static final String ERROR_OF_DUPLICATE = "[ERROR] 보너스 번호가 이미 당첨 번호에 포함되어 있습니다.";
