...
class CheckRangeMethodTest {
    private static final String ERROR_MESSAGE = "[ERROR] 당첨 번호는 1이상 45이하의 자연수로 구성해야 합니다.";

    @Test
    void checkRange_메소드_정상_입력_테스트1() { for (int number = 1; number <= 45; number++) checkRange(number); }
