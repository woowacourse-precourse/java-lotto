...
public class LottoYieldTest {
    ...
    void oneOfEightIsFifth() {
        ...
        assertThat(lottoYield.yield()).isEqualTo(0.625);
    }
    ...
    void oneOfEightIsSecond() {
        ...
        assertThat(lottoYield.yield()).isEqualTo(30000 / 7.0);
    }
    ...
    void buyTenThousandLotto() {
        ...
        assertThat(lottoYield.yield()).isEqualTo(203.167);
    }
    ...
    void nothingWins() {
        ...
        assertThat(lottoYield.yield()).isEqualTo(0);
    }
}
