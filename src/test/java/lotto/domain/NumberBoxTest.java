...
public class NumberBoxTest {
    ...
    class WrongWinningNumbers {
        @DisplayName("당첨 번호의 개수가 6개가 아닌 경우 예외를 반환한다.")
        @Test
        ...
        @DisplayName("당첨 번호에 중복된 숫자가 있는 경우 예외를 반환한다.")
        @Test
        ...
        @DisplayName("당첨 번호가 범위 내에 있지 않는 경우 예외를 반환한다.")
        @Test
    ...
    class WrongBonusNumber {
        @DisplayName("당첨 번호와 보너스 숫자가 중복되는 경우 예외를 반환한다.")
        @Test
        ...
        @DisplayName("보너스 숫자가 범위 내에 있지 않는 경우 예외를 반환한다.")
        @Test
