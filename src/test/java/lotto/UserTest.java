...
class UserTest {
    ...
    public void userConstructorTest() {
        ...
        // then
        assertThat(user.getAmount()).isEqualTo(buyingPrice);
    }
    ...
    public void userSetLottosTest() {
        ...
        // when
        user.setAutoNumbers(user.getAmount());

        // then
        assertThat(user.getAutoNumbers().size()).isEqualTo(buyingPrice / PRICE_OF_LOTTO);
    }
    ...
    public void winningPriceTest() {
        ...
        // when
        user.addWinnings(earnMoneyByLotto);

        // then
        assertThat(user.getWinnings()).isEqualTo(earnMoneyByLotto);
    }
}