...
#### 1️⃣ 구매 관련 기능
  ...
  - [X] 구매 금액을 입력받는 기능
    - [ ] 예외 1: 숫자가 아닌 문자를 입력했는지 확인한다.
    - [ ] 구매 금액을 정수형으로 변환한다.<br>


  - [X] 구매 금액에 따른 발행할 로또의 수 구하기
    - [ ] 예외 1: 입력받은 구매 금액의 최소 단위가 1,000원 이하인지 확인한다.(ex. 10,500원, 10,010원 등)

#### 2️⃣  로또 관련 기능
- [ ] 임의의 6개의 로또 번호 생성
  - [ ] 예외 1: 6개의 번호가 중복이 생긴 경우
  - [ ] 예외 2: 생성된 로또 번호가 6개가 아닌 경우