...
### 4. 컴퓨터가 1 ~ 45 사이의 중복되지 않는 6개의 숫자를 뽑는다.
- 구매한 복권만큼 발행한다.

### 5. 컴퓨터가 1 ~ 45 중 1개의 숫자를 뽑는다.
- 구매한 복권만큼 발행한다.
- 3번에서 뽑은 6개의 숫자와 중복되지 않는다.

### 6. 발행한 로또 수량 및 번호를 출력한다.
- 3번에서 뽑은 6개의 숫자만 보여주고 4번에서 뽑은 1개의 숫자는 보여주지 않는다.
- 로또 번호는 오름차순으로 정렬하여 보여준다.

### 7. 사용자가 6개의 숫자를 입력한다.

### 8. 사용자가 입력한 숫자가 올바른 지 확인한다.
- 총 6개의 숫자가 입력되어야 한다.
...
### 10. 사용자가 입력한 숫자가 올바른 지 확인한다.
- 총 1개의 숫자가 입력되어야 한다.
- 5번에서 입력한 6개의 숫자와 중복되지 않는다.
- 해당 번호는 1부터 45 사이여야 한다.
- 위 경우가 안 지켜지면 예외 처리한다.

### 11. 사용자가 입력한 숫자와 컴퓨터가 생성한 숫자를 비교한다.
- 구매한 복권만큼 비교한다.
