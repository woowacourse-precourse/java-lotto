...
### ✅ 기능 목록
- [ ] (1) `사용자`가 구입금액을 입력한다.
    - [ ] 1-1: `구입금액을 입력해 주세요.` 를 출력한다.
    - [ ] 1-2: 1000원 단위로 입력받는다.
        * [ ] **예외1)** 문자를 입력받은 경우 예외처리한다.
        * [ ] **예외2)** 1000원으로 나누어 떨어지지 않는 경우 예외처리한다.
        * [ ] **예외3)** 빈 값을 입력받은 경우 예외처리한다.


- [ ] (2) `서비스`가 로또 수량에 맞게 랜덤으로 번호를 생성하고, 발행한 로또 수량 및 번호를 출력한다.
    - [ ] 2-1: 사용자의 구입 금액에 맞게 구입 금액에 해당하는 만큼 로또 수량을 계산한다.
    - [ ] 2-2: 계산한 로또 수량만큼 로또를 발행한다.
    - [ ] 2-3: 발행한 로또 수량에 맞게 랜덤으로 각 로또의 로또 번호 6개를 생성한다.
