...
### 14. 13번에서 예외 처리시 에러 문구를 출력한다.

### 15. 보너스 번호 입력 문구를 출력한다.

### 16. 사용자가 1개의 숫자를 입력한다.
- 총 1개의 숫자가 입력되어야 한다.

### 17. 16번에서 예외 처리시 에러 문구를 출력한다.

### 18. 사용자가 입력한 숫자가 올바른 지 확인한다.
- 10번에서 입력한 6개의 숫자와 중복되지 않는다.
- 해당 번호는 1부터 45 사이여야 한다.
- 위 경우가 안 지켜지면 예외 처리한다.

### 19. 18번에서 예외 처리시 에러 문구를 출력한다.

### 20. 사용자가 입력한 숫자와 컴퓨터가 생성한 숫자를 비교한다.
- 5번에서 결정한 만큼 비교한다.
