...
#### 당첨 결과
- [x] 당첨 번호가 3개 미만으로 일치할 경우, 6을 반환한다
- [x] 당첨 번호와 3개 일치할 경우, 5를 반환한다
- [x] 당첨 번호와 4개 일치할 경우, 4를 반환한다
- [x] 당첨 번호와 5개 일치할 경우, 3을 반환한다
- [x] 당첨 번호와 5개 일치하고 보너스 번호와 일치할 경우, 2를 반환한다
- [x] 당첨 번호와 6개 일치할 경우, 1을 반환한다
