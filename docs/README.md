...
<details>
<summary>4️⃣  당첨 판별 관련 기능</summary>
<div markdown="1">
...
<details>
<summary>5️⃣  수익 관련 기능</summary>
<div markdown="1">

- [X] 등수 조건에 따라 등수별 금액을 당첨 테이블을 정의한다.
    - [X] 등수에 맞는 금액을 반환한다.
    - [X] 로또 번호가 추첨 번호를 맞춘 상태에 맞는 등수를 반환한다.
    - [X] 로또 번호가 추첨 번호를 맞춘 상태에 맞는 등수 객체를 반환한다.
    - [X] 로또 번호가 추첨 번호를 맞춘 상태를 정의한 당첨 테이블과 비교한다. 
...
- [X] 당첨 통계를 문자열로 반환한다.
  ...
  - [X] 주어진 등수 이름과 당첨 테이블과 비교하여 원하는 정보를 찾는다.  
...
<details>
<summary>7️⃣  로또 게임 컨트롤러</summary>
<div markdown="1">


- [X] 구매 금액을 입력받으면 구매금액을 이용하여 구매할 로또의 수를 구한다.
- [X] 구매한 로또 수만큼 로또를 발행한다.
- [X] 발행한 로또에 대해 당첨 여부를 확인한다.
- [X] 당첨 통계를 낸다.
- [X] 당첨 여부에 따른 수익과 구매 금액을 이용하여 수익률을 계산한다.
