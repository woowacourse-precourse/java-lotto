...
- User
  - [] 사용자에게 중복되지 않는 숫자 6개를 쉼표로 구분하여 입력받고 보너스 번호 1개를 생성한다.
    - [] 중복된 숫자나 숫자가 아닌 값, 6개가 아닌 값, 쉼표로 구분하지 않는 값, 범위를 초과한 값(1~45)을 입력 받으면 예외처리
  - [] 사용자에게 로또 구입 금액을 입력 받고 구입 금액에 해당하는 만큼 로또를 발행한다. 
